...
const Operations = () => {
    ...
    const fetchReport = (e) => {
        ...
        postData(frmData, "fetch_operations_user_activity").then((data) => {
            console.log(data)
            if (data) {
                setReport(data);
  ...
  `;
        ...
        let html = `
    <div style="text-align:center;font-size:40px;">USER ACTIVITY</div>    
     <br/>
    ...
    return (
        <div>
            <div className="row ml-0">
                <h4 className="fs-title">Management Reports - User Activity</h4>
                <hr/>
