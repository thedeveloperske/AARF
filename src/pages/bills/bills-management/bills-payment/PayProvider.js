...
const PayProvider = () => {
    ...
    useEffect(() => {
        getData('fetch_providers_fund').then((data) => {
            setProviders(data.providers);
        });
        getData('fetch_services').then((data) => {
            const serviceDropdown = data.map((dt) => {
                return (
    ...
    const fetchProviderClaims = (e) => {
        e.preventDefault();
        document.getElementById('spinner').style.display = 'block';
        getOneData('fetch_provider_claims', e.target.value).then((data) => {
            console.log(data);
    ...
    return (
        <div>
            <div className="row ml-0">
                <h4 className="fs-title">Pay Provider</h4>
                <hr/>
                <div className="col-md-12">
                    <div className="row ml-0">
                        <div className="form-group row">
                            <label htmlFor={"task"}
                                   className="col-form-label col-sm-1 label-align pr-2 pl-0">Provider:
                            </label>
                            <div className="col-md-5">
                                <select className="form-control" id="select_provider_dropdown"
                                        onChange={fetchProviderClaims}>
            ...
            <section id="pay_provider" className="project-tab">
                <div className="row">
                    <div className="col-md-12">
                        <div className="card">
                            <form id={"pay_provider_form"} onSubmit={savePayProvider}>
                                <div className={"row"}>
