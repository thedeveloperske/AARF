...
const PolicyDocumentSme = () => {
  ...
  const closeModal = () => {
    ...
    window.location.replace("/policy-document-sme");
  };
  ...
  useEffect(() => {
    ...
    frmData.append("client_type", "sme");
    if (selectedAnniv !== "0") {
  ...
  const fetchPolicyData = (e) => {
    ...
    const frmData = new FormData(document.getElementById("frmPolicyDocument"));
    frmData.append("client_type", "sme");
    frmData.append("corp_id", selectedSme);
 ...
 <tr><th colspan="2" style="color:white;background-color:red;text-align:center;font-size:20px;">Inpatient Benefits (Pre-authorization will be required for inpatient cover)</th></tr> 
    ...
    tblFive += `
     <tr><th colspan="2" style="color:white;background-color:red;text-align:center;font-size:20px;">Maternity Cover (For Principal and Spouse only in Uganda) : Pre-authorization will be required for cover</th></tr> 
      ...
      <tr><th>${TblFiveRows[4].children[0].textContent}</th><th>${
      TblFiveRows[4].children[1].children[0].options[
        TblFiveRows[4].children[1].children[0].selectedIndex
      ].text
    }</th></tr>  
    `;
    tblSix += `
    ...
    <div>
      <div className="policyDocument">
        <div className="container">
          <p className="text-info h2">POLICY DOCUMENT SME</p>
          <hr />
              ...
              <tr>
                ...
                <td>
                  ...
                  <input
                    ...
                    type="text"
                    value={
                      typeof policyData.op_chronic_conditions !== "undefined" &&
                      policyData.op_chronic_conditions != null
                        ? parseFloat(
...
export default PolicyDocumentSme
