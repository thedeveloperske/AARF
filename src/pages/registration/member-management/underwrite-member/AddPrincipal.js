...
const AddPrincipal = () => {
  ...
  useEffect(() => {
    ...
    getData("member_dropdowns").then((data) => {
      ...
      setmemberNo("UG" + (parseInt(data.max_id) + 1) + "-00");
    });
  }, []);
  ...
  const closeModal = () => {
    ...
    if (feedback[0] !== "Please fill in all information!") {
      window.location.replace("add-principal");
    }
  };
  return (
    <div>
                      ...
                      <div className="form-group row ml-0 ">
                        ...
                        <div className="col-sm-4">
                          <input
                            ...
                            className="form-control"
                            onChange={(e) =>
                              setNames({ surname: e.target.value })
                            }
                            name="surname"
                            id="surname"
                          />
                        ...
                        <div className="col-md-4 col-sm-4">
                          <input
                            ...
                            className="form-control"
                            onChange={(e) =>
                              setNames({ first_name: e.target.value })
                            }
                            name="first_name"
                            id="first_name"
                          />
                      ...
                      <div className="form-group row ml-0 ">
                        ...
                        <div className="col-md-4 col-sm-4 ">
                          <input
                            type="text"
                            onChange={(e) =>
                              setNames({ other_names: e.target.value })
                            }
                            className="form-control"
                            name="other_names"
                            id="other_names"
